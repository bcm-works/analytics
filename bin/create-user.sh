...
if [ -z "$APP_USER_NAME" ] || [ -z "$APP_USER_EMAIL" ] || [ -z "$APP_USER_PASS" ]; then
  echo "Error: The environment vars APP_USER_NAME, APP_USER_EMAIL and APP_USER_PASS must be set."
  exit 1
fi

echo "Creating app user for '$APP_USER_NAME'"
